  ...
  ($.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      if ($('body').hasClass('fixed'))
        ...
        var d;
        b >= c
          ? ($('.home-section, .right-side').css('min-height', b - a),
            (d = b - a))
          : ($('.home-section, .right-side').css('min-height', c), (d = c));
        var e = $($.AdminLTE.options.controlSidebarOptions.selector);
        'undefined' != typeof e &&
          e.height() > d &&
          $('.home-section, .right-side').css('min-height', e.height());
      }
    },
    fixSidebar: function () {
    ...
    ($.AdminLTE.controlSidebar = {
      activate: function () {
        ...
        a._fix(e),
          $('body').hasClass('fixed')
            ? a._fixForFixed(c)
            : $('.home-section, .right-side').height() < c.height() &&
              a._fixForContent(c);
      },
      open: function (a, b) {
        b
      ...
      _fixForContent: function (a) {
        $('.home-section, .right-side').css('min-height', a.height());
      },
    }),
    ($.AdminLTE.boxWidget = {
